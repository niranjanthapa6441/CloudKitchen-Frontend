...
class RouteHelper {
  ...
  static String getOrderDetail(int pageId) =>
      '$orderDetail?pageId=$pageId';
  static String getAvailablePaymentMethods() => availablePaymentMethods;
  static String getConfirmOrder() => confirmOrder;
  static String getFoodDetail(int pageId) =>
      '$foodDetail?pageId=$pageId';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: searchFoods, page: () => const SearchFoodsPage()),
